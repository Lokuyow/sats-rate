...
function initializeSortable() {
    ...
    new Sortable(floatingContainer, {
        animation: 150,
        filter: '.sort-solid', // .sort-solid 要素を除外
        onEnd: () => {
...
function displaySelectedCurrencies() {
    ...
    // .sort-solid を保持するためにその内容を先にクリア
    const sortSolid = document.querySelector('.sort-solid');
    floatingContainer.innerHTML = '';
    floatingContainer.appendChild(sortSolid);
