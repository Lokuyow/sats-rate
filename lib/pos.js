...
export class Pos {
  ...
  #lnAddress = new LightningAddress('');
  ...
  setLnAddress(form) {
    ...
    this.#lnAddress = formData.get('lightning-address');
    window.localStorage.setItem(this.localStorageKey, this.#lnAddress);
    console.debug(`Pos: set lnAddress: ${this.#lnAddress}`);
  }
